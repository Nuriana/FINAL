				...
				<div class="head-nav">
					<span class="menu"> </span>
						...
						<li class="active"><a href="<?= base_url('home') ?>">HOME</a></li>
							...
							<?php }else{ ?>
								<li><a href="<?= base_url('login') ?>" data-hover="">LOGIN</a></li>
							<?php } ?>							
			...
			<div class="contact">
					...
					<div class="contact-down">
							<div class="contact-right">
								<h2>Register</h2>
								<?= form_open_multipart(base_url().'register/regist'); ?>
								<div class="col-md-4 col-md-offset-4 contact-left">
									...
									<div class="form-inline">
										...
										<div class="form-group">
											<a href="<?= base_url('login') ?>" class="btn pull-right btn-primary">Login</a>
										</div>
									</div>
									<?= form_open('register'); ?>
								</div>
